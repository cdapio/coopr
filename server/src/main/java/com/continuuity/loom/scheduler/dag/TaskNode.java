...
public class TaskNode {
  ...
  /**
   * Get the id of the {@link com.continuuity.loom.cluster.Node} associated with this task node. It is called
   ...
   *
   * @return id of the {@link com.continuuity.loom.cluster.Node} this task will be executed on.
   */
