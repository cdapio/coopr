...
public class TestHelper {
  ...
  public static SchedulableTask takeTask(String url, TakeTaskRequest request) throws Exception {
    HttpPost httpPost = new HttpPost(String.format("%s/tasks/take", url));
  ...
  public static void finishTask(String url, FinishTaskRequest finishRequest) throws Exception {
    HttpPost httpPost = new HttpPost(String.format("%s/tasks/finish", url));
