...
public class LoomClusterHandlerTest extends LoomServiceTestBase {
  ...
  protected static ClusterRequest createClusterRequest(String name, String description,
    ...
    return new ClusterRequest(name, description, template, numMachines, null, null, null, null, -1L, null, null);
  }

  protected static ClusterRequest createClusterRequest(String name, String description, String template,
                                                       int numMachines, JsonObject userConfig) {
    return new ClusterRequest(name, description, template, numMachines, null, null, null, null, -1L, null, userConfig);
  }
