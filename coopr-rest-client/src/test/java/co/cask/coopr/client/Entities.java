...
public class Entities {
  ...
  public static class ServiceExample {
    public static final Service HOSTS = Service.builder()
      ...
      .setProvisionerActions(ImmutableMap.<ProvisionerAction, ServiceAction>of(
        ...
        new ServiceAction("chef-solo", actionMapOf("recipe[coopr_hosts::default]", null))
      ))
      .build();
    public static final Service NAMENODE = Service.builder()
      ...
      .setProvisionerActions(ImmutableMap.<ProvisionerAction, ServiceAction>of(
        ...
        new ServiceAction("chef-solo", actionMapOf("recipe[hadoop::hadoop_hdfs_namenode]", null)),
        ProvisionerAction.INITIALIZE,
        new ServiceAction("chef-solo",
                          actionMapOf("recipe[hadoop_wrapper::hadoop_hdfs_namenode_init]", null)),
        ProvisionerAction.CONFIGURE,
        new ServiceAction("chef-solo",
                          actionMapOf("recipe[hadoop::default]", null)),
        ProvisionerAction.START,
        new ServiceAction("chef-solo",
                          actionMapOf("recipe[coopr_service_runner::default]", "start data")),
        ProvisionerAction.STOP,
        new ServiceAction("chef-solo",
                          actionMapOf("recipe[coopr_service_runner::default]", "stop data"))))
      .build();
    public static final Service DATANODE = Service.builder()
      ...
      .setProvisionerActions(ImmutableMap.<ProvisionerAction, ServiceAction>of(
        ProvisionerAction.INSTALL,
        new ServiceAction("chef-solo",
                          actionMapOf("recipe[hadoop::hadoop_hdfs_datanode]", null)),
        ProvisionerAction.INITIALIZE,
        new ServiceAction("chef-solo",
                          actionMapOf("recipe[hadoop_wrapper::hadoop_hdfs_datanode_init]", null)),
        ProvisionerAction.CONFIGURE,
        new ServiceAction("chef-solo",
                          actionMapOf("recipe[hadoop::default]", null)),
        ProvisionerAction.START,
  ...
  protected static Map<String, String> actionMapOf(String script, String data) {
