...
- CLI - Add dependency to slf4j-nop for correct bindings COOPR-624 ( Issues: #805 )
...
- CLI - Commands do not function when given on command line COOPR-625 ( Issues: #801 )
...
- CLI - Does not show current user or tenant COOPR-600 ( Issues: #779 )
...
- Coopr UI - SSL TLS improvements - coopr.sh and server.js imrovements ( Issues: #764 )
...
- Coopr UI - Old UI - Remove then restore coopr-integration-testing ( Issues: #818 #820 #830 )
...
- Provisioner - Prevent potential null pointer in server startup failure scenarios ( Issues: #687 )
- Provisioner - Provisioner top-level CI framework ( Issues: #775 #778 )
- Provisioner - Run register in foreground ( Issues: #812 )
- Provisioner - Security - Changes in provisioner to use TLS when talking to server COOPR-568 ( Issues: #773 )
- Provisioner - Set up - Fix exit code of setup script ( Issues: #595 )
...
- Provisioner worker - Add a way to disable the base cookbooks ( Issues: #837 )
...
- Provisioner worker - Always exit 0, even if last if does not match ( Issues: #548 )
- Provisioner worker - Another shell nullpointer ( Issues: #701 )
- Provisioner worker - Better output on credential failures ( Issues: #703 )
- Provisioner worker - Bug fixes ( #582 #659 #666 #699 #755 #825 )
- Provisioner worker - Chef 12 has updated defaults, force latest Chef 11 ( Issues: #828 )
- Provisioner worker - Clean up rubocop and let it autocorrect some minor things ( Issues: #790 #829 )
- Provisioner worker - Create node_modules cookbook ( Issues: #728 )
- Provisioner worker - Do not require Internet for chef-solo bootstrap COOPR-621 ( Issues: #793 )
...
- Provisioner worker - Update to latest mongodb cookbook ( Issues: #730 )
...
- Provisioner worker - php_modules - fixes ( Issues: #668 #670 #671 #672 )
- Provisioner worker - redis cookbook updates ( Issues: #743 )
- Rest client - Add unit tests for negative cases, refactor AdminRestClient  ( Issues: #674 )
- Rest client - Added ability to specify non default Gson object to RestClient ( Issues: #697 )
...
- Rest client - Gix plugin rest tests fail flapping ( Issues: #726 )
- Rest client - Implement Plugins REST Client API Interface COOPR-526 ( Issues: #682 )
- Rest client - Implement Tenant and Provisioner client API with unit tests COOPR-527 ( Issues: #673 )
- Rest client - Integration tests COOPR-543 ( Issues: #698 )
- Rest client - Plugins Rest client integration tests COOPR-548 ( Issues: #717 )
...
- Server - Add label as a field to providers, hardwaretypes, imagetypes, services, and cluster templates. Also refactor for sharing common fields COOPR-513 ( Issues: #643 )
...
- Server - AdminHandler /v2/import method writes clustertemplates two times COOPR-649 ( Issues: #838 )
- Server - Bug fixes COOPR-488 COOPR-567 ( Issues: #589 #626 #645 #754 #776 )
...
- Server - Make sure all system generated hostnames have labels that do not exceed 63 characters and are lower case COOPR-324 ( Issues: #644 )
- Server - Move a cluster to 'terminated' state instead of 'incomplete' if all create tasks failed this way COOPR-516 ( Issues: #649 )
...
- Server - Use coopr-templates submodule ( Issues: #692 )
...
- Templates - Add coopr-templates as a top-level submodule ( Issues: #681 )
- Templates - Update refs ( Issues: #706 #722 #735 )
...
- NGUI - Bug fixes - COOPR-457, COOPR-64, COOPR-512, COOPR-534, COOPR-544 ( Issues: #679 #688 #724 #774 #786 )
