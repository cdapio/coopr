 ...
 */
public class ProviderCodec extends BaseAdminEntityCodec<Provider> {
  ...
  @Override
  protected BaseAdminEntity.Builder<Provider> getBuilder(JsonObject jsonObj, JsonDeserializationContext context) {
