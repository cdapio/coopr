...
public interface EntityStoreView {
   ...
   * @throws Exception
   */
  PartialTemplate getPartialTemplate(String partialTemplateName, int version, boolean isMandatory) throws IOException;
   ...
   * @throws Exception
   */
  void writePartialTemplate(PartialTemplate partialTemplate, boolean isMandatory)
   ...
   * @throws Exception
   */
  void deletePartialTemplate(String partialTemplateName, boolean isMandatory)
          throws IOException, IllegalAccessException;
   ...
   * @throws Exception
   */
  void deletePartialTemplate(String partialTemplateName, int version, boolean isMandatory)
          throws IOException, IllegalAccessException;
