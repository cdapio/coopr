 ...
 * responsible for calling the {@link #canApplyChange(co.cask.coopr.layout.ClusterLayout)} method to validate
 * if a change can be applied to a layout before actually applying the change with
 * {@link #applyChange(co.cask.coopr.layout.ClusterLayout)} or
 * {@link #applyChange(co.cask.coopr.cluster.Cluster, java.util.Set, java.util.Map)}.
 */
