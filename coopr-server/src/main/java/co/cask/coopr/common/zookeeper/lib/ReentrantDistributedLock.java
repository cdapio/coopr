...
public final class ReentrantDistributedLock implements Lock {
   ...
   *
   * @param zkClient the {@link org.apache.twill.zookeeper.ZKClient} to interact with the ZooKeeper used for the lock coordination
   ...
   * @throws java.util.concurrent.ExecutionException if there is failure while trying to acquire the lock
   */
