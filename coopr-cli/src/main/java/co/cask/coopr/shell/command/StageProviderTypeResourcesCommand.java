 ...
 */
public class StageProviderTypeResourcesCommand extends AbstractAuthCommand {

  private final PluginClient pluginClient;

  @Inject
  public StageProviderTypeResourcesCommand(PluginClient pluginClient, CLIConfig cliConfig) {
    super(cliConfig);
