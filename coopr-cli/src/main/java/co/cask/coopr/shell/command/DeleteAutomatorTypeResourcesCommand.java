 ...
 */
public class DeleteAutomatorTypeResourcesCommand extends AbstractAuthCommand {

  private final PluginClient pluginClient;

  @Inject
  public DeleteAutomatorTypeResourcesCommand(PluginClient pluginClient, CLIConfig cliConfig) {
    super(cliConfig);
