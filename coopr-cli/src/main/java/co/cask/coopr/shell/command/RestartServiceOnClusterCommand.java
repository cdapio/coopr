 ...
 */
public class RestartServiceOnClusterCommand implements Command {
  ...
  @Inject
  public RestartServiceOnClusterCommand(ClusterClient clusterClient) {
  ...
  public String getPattern() {
    return "restart service <service-id> on cluster <cluster-id>[ with provider fields <provider-fields>]";
  }
