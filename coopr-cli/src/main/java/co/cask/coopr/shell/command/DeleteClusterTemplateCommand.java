 ...
 */
public class DeleteClusterTemplateCommand extends AbstractAuthCommand {

  private final AdminClient adminClient;

  @Inject
  private DeleteClusterTemplateCommand(AdminClient adminClient, CLIConfig cliConfig) {
    super(cliConfig);
  ...
  public void perform(Arguments arguments, PrintStream printStream) throws Exception {
    ...
    adminClient.deleteClusterTemplate(name);
  }
