...
/**
 * Stage automator type resource version.
 */
public class StageAutomatorTypeResourcesCommand extends AbstractAuthCommand {

  private final PluginClient pluginClient;

  @Inject
  public StageAutomatorTypeResourcesCommand(PluginClient pluginClient, CLIConfig cliConfig) {
    super(cliConfig);
  ...
  public void perform(Arguments arguments, PrintStream printStream) throws Exception {
    ...
    pluginClient.stageAutomatorTypeResource(automatorTypeId, resourceType, resourceName, version);
  }

  @Override
  public String getPattern() {
    return String.format("stage resource from automator <%s> of type <%s> and name <%s> and version <%s>",
                         AUTOMATOR_TYPE_ID, RESOURCE_TYPE, RESOURCE_NAME, RESOURCE_VERSION);
  }

  @Override
  public String getDescription() {
    return "Stage a specific version of an automator type resource";
  }
}
