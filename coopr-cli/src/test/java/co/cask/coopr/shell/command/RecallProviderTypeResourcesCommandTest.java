...
/**
 * {@link co.cask.coopr.shell.command.RecallProviderTypeResourcesCommand} class test.
 */
public class RecallProviderTypeResourcesCommandTest extends AbstractTest {
  ...
  public void testExecute() throws Exception {
    ...
    Mockito.verify(PLUGIN_CLIENT).recallProviderTypeResource(Mockito.eq(TEST_PLUGIN_TYPE),
